...
int main()
{
    ...
    Shader outlineShader("shaders/vertex_shader.glsl", "shaders/fragment_shader_single_color.glsl");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        outlineShader.setMat4("projection", projection); // note: currently we set the projection matrix each
